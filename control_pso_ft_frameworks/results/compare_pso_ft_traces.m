...
%% LOAD RESULTS
load('results_from_pso_framework.mat');
...
set(gca,'FontSize',11)
% xlim([0 3]); ylim([-0.3 0.5]);
% str = legend([stairs2 stairs3], {'error injection with fault-tolerant mechanism', ...
%                            'error injection without fault-tolerant mechanism'});
% set(str,'Interpreter','latex','fontsize',11)
