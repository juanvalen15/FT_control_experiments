...
% CONTINUOUS TIME PATO SYSTEM MODEL - REFENRECE MEASURED MODEL 
% System parameters
...
Ac_plant = [0 0 1 0 ; 0 0 0 1; -k/J1  k/J1 -(d+b)/J1 d/J1; k/J2 -k/J2  d/J2 -(d+b)/J2];
Bc_plant = [0; 0; Km/J1; 0];
Cc_plant = eye(4);
Dc_plant = [0;0;0;0];



%% PLANT MODEL UPDATE: INCLUDING ELECTRICAL CIRCUIT FOR THE COMPSOC PLATFORM
% % PLANT: motion system
