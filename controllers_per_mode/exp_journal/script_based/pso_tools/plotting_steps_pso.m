...
[Phi,Gamma] = DiscretizeDelayShort(Ac_plant, Bc_plant, application_delay, Ts); % discrete time system
...
%% SETTLING TIME
Settling_times(1)= setim_mex(Ac_plant, Bc_plant, K, F, R, delay, Ts, Sett); % computes the settling time; % computes the settling time
